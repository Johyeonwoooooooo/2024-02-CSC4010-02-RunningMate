...
const RunningWaitingRoom = () => {
  ...
  const cancelParticipation = async () => {
    ...
    try {
      ...
      Alert.alert("오류", `방 나가기에 실패했습니다. (${err.message})`, [
        {
          text: "확인",
  ...
  const handleLeaveRoom = () => {
    Alert.alert("방 나가기", "정말로 방을 나가시겠습니까?", [
      {
        text: "취소",
        style: "cancel",
      },
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity
        style={[styles.leaveButton, isLoading && styles.leaveButtonDisabled]}
